...
# in Pysc_detect.  This includes a base object (sc_detector) upon which all
...
def get_available():
    ...
    Returns:
        A dictionary with the form {name (string): detector (sc_detector)},
...
class ThresholdDetector(sc_detector):
...
class ContentDetector(sc_detector):
...
class MotionDetector(sc_detector):
...
#                                                                             #
#
# class EdgeDetector(sc_detector):
...
#                                                                             #
#                                                                             #
# class DissolveDetector(sc_detector):
...
#                                                                             #
#                                                                             #
# class HistogramDetector(sc_detector):
